...
const DEFAULT_NEWSLETTER_API_URL = process.env.NEWSLETTER_API_URL || 'https://ssl-vp.com/rest/v1/Contacts?updateIfExists=true&restoreIfDeleted=true&restoreIfUnsubscribed=true&api_key=68701475-bf12-46b4-8854-8bd40b8d09ad';
