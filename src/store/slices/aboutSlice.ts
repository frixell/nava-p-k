...
const aboutSlice = createSlice({
  ...
  initialState,
  reducers: {
    setAboutPage: (_state: AboutPageState, action: PayloadAction<Partial<AboutPageState> | null>) =>
...
export const { setAboutPage, updateAboutPage, updateAboutSeo, saveAboutImage } = aboutSlice.actions;

export const startSetAboutPage =
  (): AppThunk<Promise<AboutPageState>> => async (dispatch: AppDispatch) => {
...
export const startEditAboutPageSeo =
  (seo: AboutSeo): AppThunk<Promise<AboutSeo>> =>
  async (dispatch: AppDispatch) => {
...
export const startSaveAboutImage =
  (imageData: Partial<ImageAsset> = {}, publicIdToDelete?: string): AppThunk<Promise<ImageAsset>> =>
  async (dispatch: AppDispatch) => {
